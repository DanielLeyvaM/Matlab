...
if(autocorrelaion <= 10 && autocorrelaion >= 0.11)
fprintf("Palabra correcta, Felicidades te ganaste un auto!!! ");
% tarjeta=arduino('com3' , 'uno');
%     for i=0:5
%     writeDigitalPin(tarjeta,"d13",1)
%     pause(1)
%     writeDigitalPin(tarjeta, "d13",0)
%     pause(1)
%     end
else
