...
fprintf("Palabra alcanzado, Led azul encendido!!! ");
...
%%%%%%%%%%%%%%%%%%%%ESTABLERO%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
if(autocorrelaion <= 100 && autocorrelaion >= 70)%%%%%modifica aqui de acuerdo a tu voz
fprintf("Palabra establero, Led verde encendido!!! ");
%     tarjeta=arduino('com3' , 'uno');
%     for i=0:5
...
%%%%%%%%%%%%%%%%%%%%TRASCARTARSE%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    
if(autocorrelaion <= 20 && autocorrelaion >= 0.11)%%%%%modifica aqui de acuerdo a tu voz
fprintf("Palabra trascartarse, Led amarillo encendido!!! ");
%     tarjeta=arduino('com3' , 'uno');
%     for i=0:5
